...
type GeneratorArgs struct {
	...
	// If true, only dry run the generator logic, don't write new package or verify
	// existing package.
	...
	//       GeneratorArgs.VerifyOnly is true or false.
	DryRunOnly bool
...
func (g *GeneratorArgs) AddFlags(fs *pflag.FlagSet) {
	...
	fs.BoolVar(&g.DryRunOnly, "dryrun-only", g.DryRunOnly, "If true, only dry run the generator logic, don't write new package or verify existing package.")
