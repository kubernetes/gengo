...
func Default() *GeneratorArgs {
	return &GeneratorArgs{
		...
		ImportBuildTag:             "ignore_autogenerated",
...
type GeneratorArgs struct {
	...
	// ImportBuildTag is the tag used to import source files by go build parser
	ImportBuildTag string
...
func (g *GeneratorArgs) AddFlags(fs *pflag.FlagSet) {
	...
	fs.StringVar(&g.ImportBuildTag, "import-tag", g.ImportBuildTag, "A Go build tag to use to identify files imported for parsing by this command.")
}
...
func (g *GeneratorArgs) NewBuilder() (*parser.Builder, error) {
	...
	// By default, ignore all auto-generated files.
	b.AddBuildTags(g.ImportBuildTag)
